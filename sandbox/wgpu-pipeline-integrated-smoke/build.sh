...
FIRST_PIXEL_VERDICT='CONTRACT ghost_redraw_recovery PASS cases=59 periodic=15 late=immediate drops=bounded readiness=rearmed resize_commit=fresh present_barrier=ordered-sync-commit-superseded trace=bounded-exact frame_ownership=reactivation-stable wrap=rearmed'
