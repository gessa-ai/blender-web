...
REQUIRED_PROJECT_PATHS = (
    ...
    "scripts/build-shader-cache-seed.py",
    "scripts/subset-loader-font.py",
    ...
    "platform_web/shell/fonts/README.md",
    "platform_web/shell/fonts/bw-interface-sans.woff2",
    "platform_web/shell/fonts/bw-console-mono.woff2",
    "platform_web/shader_cache/README.md",
    "platform_web/shader_cache/first_boot.bwsp",
    "platform_web/shader_cache/first_boot.seed.json",
    ...
    "sandbox/m8-shader-cache-seed/verify.py",
