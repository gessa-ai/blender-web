...
// the FULL browser console to a log so the BW_DIAG-gated [bw-r44r2] expected-vs-emitted
...
const PORT = parseInt(process.argv[5] || '8128', 10);
...
page.on('console', (m) => {
  const t = m.text();
  allLines.push(t);
  if (t.includes('[bw-r44r2]')) bindLines.push(t);
