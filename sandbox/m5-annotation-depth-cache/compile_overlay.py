...
"""Compile reconstructed annotation source with a locked product-graph command."""
...
def main() -> int:
    ...
    if len(matches) != 1:
        raise SystemExit(f"expected one compile command for {args.relative}, found {len(matches)}")
    ...
    print(
        "M5_ANNOTATION_DEPTH_CACHE_TU_COMPILE_PASS "
