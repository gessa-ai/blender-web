...
F32/F11/F10 policy, and invalid/boundary behavior. Native and Wasm stdout must
be byte-identical.
...
canonical clean-pin replay, and the ten exact table/conversion/texture/enum/oracle inputs
