...
|---|---|
| `/Users/paws/blender-web` in M4 capture | Removed; root is derived from `import.meta.url`. |
| `NODE_PATH=/Users/paws/plushly/game-platform/node_modules` | `BW_NODE_MODULES=$PWD/.m4-node/node_modules`; Playwright 1.61.1 installed locally. |
