...
"""Compile patched direct-dolly code with a locked product graph's exact command."""
...
SOURCE_SUFFIX = "/source/blender/editors/space_view3d/view3d_navigate_view_dolly.cc"
...
def main() -> int:
    ...
    if len(matches) != 1:
        raise SystemExit(f"expected one direct-dolly compile command, found {len(matches)}")
    ...
    print(
        "M5_DOLLY_DEPTH_TU_COMPILE_PASS "
