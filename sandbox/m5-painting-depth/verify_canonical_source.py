...
"""Replay canonical source for the painting contract without mutating upstream."""
...
EXPECTED_PATHS = (
    ...
    Path("source/blender/editors/sculpt_paint/paint_intern.hh"),
    Path("source/blender/editors/sculpt_paint/mesh/paint_image_proj.cc"),
    Path("source/blender/editors/sculpt_paint/mesh/paint_image_ops_paint.cc"),
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="m5-painting-canonical-") as temporary:
    ...
    print(
        "M5_PAINTING_DEPTH_CANONICAL_REPLAY_PASS "
...
if __name__ == "__main__":
    try:
        ...
        print(
            f"M5_PAINTING_DEPTH_CANONICAL_REPLAY_FAIL {error}",
