...
"""Reverse and forward patch 0269 against its exact current postimage."""
...
EXPECTED_NAME = "0269-m5-grease-pencil-primitive-depth-cache-continuation.patch"
EXPECTED_PATH = Path(
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="m5-gp-primitive-depth-patch-") as temporary:
    ...
    print(
        "M5_GREASE_PENCIL_PRIMITIVE_DEPTH_CACHE_NUMBERED_PATCH_PASS "
        f"files=1 sha256={digest}"
    )
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(
            f"M5_GREASE_PENCIL_PRIMITIVE_DEPTH_CACHE_NUMBERED_PATCH_FAIL {error}",
