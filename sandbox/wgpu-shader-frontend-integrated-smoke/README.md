...
1D-array, and finite-value builtin rewrite helpers. Native and Wasm executions must
produce byte-identical evidence. Live-device sections are discarded at link;
