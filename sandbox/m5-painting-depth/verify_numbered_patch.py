...
"""Reverse and forward patch 0261 against its exact current postimage."""
...
EXPECTED_NAME = "0261-m5-painting-depth-continuation.patch"
EXPECTED_PATHS = {
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="m5-painting-patch-") as temporary:
    ...
    print(f"M5_PAINTING_DEPTH_NUMBERED_PATCH_PASS files=3 sha256={digest}")
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(
            f"M5_PAINTING_DEPTH_NUMBERED_PATCH_FAIL {error}",
