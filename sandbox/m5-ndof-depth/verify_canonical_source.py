...
"""Replay selected canonical NDOF-depth sources without mutating upstream."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="m5-ndof-depth-canonical-") as temporary:
    ...
    print(
        "M5_NDOF_DEPTH_CANONICAL_REPLAY_PASS "
...
if __name__ == "__main__":
    try:
        ...
        print(
            f"M5_NDOF_DEPTH_CANONICAL_REPLAY_FAIL {error}",
