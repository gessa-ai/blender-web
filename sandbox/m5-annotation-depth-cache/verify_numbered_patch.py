...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="m5-annotation-depth-cache-patch-") as temporary:
    ...
    print(f"M5_ANNOTATION_DEPTH_CACHE_NUMBERED_PATCH_PASS files=1 sha256={digest}")
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(f"M5_ANNOTATION_DEPTH_CACHE_NUMBERED_PATCH_FAIL {error}", file=__import__("sys").stderr)
        raise SystemExit(1)
